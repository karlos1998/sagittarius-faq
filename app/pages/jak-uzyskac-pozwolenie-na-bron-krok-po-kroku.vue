<template>
  <div class="bg-gradient-to-b from-blue-50 via-white to-blue-100">
    <SeoHead
    ...
    <div class="flex justify-center pt-4 pb-6">
      <NuxtLink to="/"
                class="inline-flex items-center gap-2 px-6 py-2 rounded-2xl bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 font-semibold shadow text-base transition">
