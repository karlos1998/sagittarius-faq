      ...
      <div class="container mx-auto px-4">
        <div class="max-w-2xl mx-auto space-y-10">
          <h1 class="text-3xl md:text-4xl font-extrabold text-blue-700 mb-10 text-center">Ogólne zasady bezpieczeństwa w
            sporcie strzeleckim</h1>

          <!-- §1 Card -->
          <div class="bg-white rounded-2xl shadow-xl p-7 border-l-8 border-blue-500">
            <div class="font-bold text-xl text-blue-900 mb-2">§ 1</div>
            <ol class="list-decimal ml-6 text-gray-800 space-y-2">
              <li>Za bezpieczne prowadzenie zawodów strzeleckich odpowiada <b>sędzia główny zawodów</b> oraz <b>sędzia
                prowadzący strzelanie</b>, posiadający licencję sędziego strzelectwa przyznaną przez Polski Związek
          ...
          <!-- §3 Card -->
          <div class="bg-white rounded-2xl shadow-xl p-7 border-l-8 border-yellow-500">
            <div class="font-bold text-xl text-yellow-700 mb-2">§ 3</div>
            <div class="mb-4 font-semibold text-gray-700">Szczególne zasady bezpieczeństwa podczas uprawiania sportu
              strzeleckiego:
            </div>
            <ol class="list-decimal ml-6 text-gray-800 space-y-2">
              ...
              <li>Broń można ładować wyłącznie na stanowisku strzeleckim, z lufą skierowaną w kulochwyt, dopiero po
                komendzie prowadzącego strzelanie.
              </li>
              <li>Podczas ładowania broni nie można korzystać z pomocy innych osób.</li>
              <li>Po komendzie lub sygnale <span
              ...
              <li>Prowadzący strzelanie odpowiada za wydawanie komend <span
                  class="inline-block bg-yellow-100 font-semibold px-2 rounded">"ŁADUJ", "START", "STOP", "ROZŁADUJ"</span>
                i innych niezbędnych poleceń oraz musi być pewien, że jego komendy są wykonywane, a posługiwanie się
                bronią odbywa się w sposób bezpieczny.
              </li>
              <li>W przypadku niezastosowania się do poleceń prowadzącego strzelanie każda osoba przebywająca na
                strzelnicy może zostać usunięta ze strzelnicy.
              </li>
              <li>Po zakończeniu strzelania, przed opuszczeniem stanowiska strzeleckiego, broń bezwzględnie należy
                rozładować i zabezpieczyć widocznym wskaźnikiem bezpieczeństwa oraz przedstawić do kontroli prowadzącemu
                strzelanie.
              </li>
              ...
              <li>Dzieci mogą przebywać na strzelnicy wyłącznie pod bezpośrednim nadzorem rodziców lub opiekunów.</li>
            </ol>
          </div>

          <!-- §4 Card -->
          <div class="bg-white rounded-2xl shadow-xl p-7 border-l-8 border-indigo-500">
            <div class="font-bold text-xl text-indigo-800 mb-2">§ 4</div>
            <div class="text-gray-800">Zasady bezpieczeństwa w sporcie strzeleckim przyjęto uchwałą Zarządu PZSS, 24
              kwietnia 2013 roku.
            </div>
          </div>
        </div>
