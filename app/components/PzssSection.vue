          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4">
              ...
              <div class="flex-grow">
                ...
                <p class="text-gray-700">
                  System automatycznie uzupełni niektóre Twoje dane. Uzupełnij brakujące informacje, które są oznaczone
                  czerwoną gwiazdką, a także załącz wymagane skany (np. zdjęcia legitymacyjne).
                </p>
              </div>
            </div>
            ...
            <div class="flex gap-4">
              ...
              <div class="flex-grow">
                ...
                <p class="text-gray-700">
                  Gdy wszystkie dane są uzupełnione, kliknij "Zapisz". Następnie zaznacz odpowiednie zakresy strzelań i
            ...
            <div class="flex gap-4">
              ...
              <div class="flex-grow">
                ...
                <p class="text-gray-700">
                  ...
                  Strzelectwa Sportowego (WZSS), co jest warunkiem rozpoczęcia procesu rozpatrywania wniosku przez PZSS.
                </p>
              </div>
            </div>
          </div>
